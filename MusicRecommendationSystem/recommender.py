...
recommendation using the implicit library in Python."""
...
if __name__ == "__main__":
    ...
    user_artists = load_user_artists(Path("../LastFM data/user_artists.dat"))

    # instantiate artist retriever
    artist_retriever = ArtistRetriever()
    artist_retriever.load_artists(Path("../LastFM data/artists.dat"))
